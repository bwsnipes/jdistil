...
/**
  ...
  @author - Bryan Snipes
*/
public class SaveCode extends SaveDataObject<Integer, Code> {

  /**
    Creates a new SaveCode object.
  */
  public SaveCode() {
    super(Code.class, CodeManager.class, FieldIds.CODE_ID, AttributeNames.CODE, 
        true, ViewCodes.class, EditCode.class, false);
  }
}
