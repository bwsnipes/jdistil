...
--
insert into bws_task (task_id, name, domain_id)
  select coalesce(max(task_id), 0) + 1, 'Manage Codes', 0 from bws_task
;

insert into bws_action (action_id, secure_id, task_id, domain_id) 
  select 
    a.action_id, 
    'CDA1',
    b.task_id,
...
insert into bws_field_group (group_id, name, domain_id)
  select coalesce(max(group_id), 0) + 1, 'Code', 0 from bws_field_group
;

insert into bws_field (field_id, name, secure_id, group_id, domain_id)
  select 
    a.field_id,
    'Name',
    'CDF4',
...
--
insert into bws_task (task_id, name, domain_id)
  select coalesce(max(task_id), 0) + 1, 'Manage Roles', 0 from bws_task
;
...
insert into bws_field_group (group_id, name, domain_id)
  select coalesce(max(group_id), 0) + 1, 'Role', 0 from bws_field_group
;
...
--
insert into bws_task (task_id, name, domain_id)
  select coalesce(max(task_id), 0) + 1, 'Manage Users', 0 from bws_task
;
...
insert into bws_field_group (group_id, name, domain_id)
  select coalesce(max(group_id), 0) + 1, 'User', 0 from bws_field_group
;
