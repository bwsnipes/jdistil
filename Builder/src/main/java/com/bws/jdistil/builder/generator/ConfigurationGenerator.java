	...
	private void loadTemplates() throws GeneratorException {
		...
		try {
			...
			if (configurationTemplate == null) {
				configurationTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/configuration.txt");
			}

			if (constantTemplate == null) {
				constantTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/constant.txt");
			}

			if (fieldTemplate == null) {
				fieldTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/field.txt");
			}

			if (addFieldToFieldsTemplate == null) {
				addFieldToFieldsTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-field-to-fields.txt");
			}

			if (addNumberRuleTemplate == null) {
				addNumberRuleTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-number-rule.txt");
			}

			if (addMaxLengthRuleTemplate == null) {
				addMaxLengthRuleTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-max-length-rule.txt");
			}

			if (addConverterRuleTemplate == null) {
				addConverterRuleTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-converter-rule.txt");
			}

			if (addEmailRuleTemplate == null) {
				addEmailRuleTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-email-rule.txt");
			}

			if (addPhoneNumberRuleTemplate == null) {
				addPhoneNumberRuleTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-phone-number-rule.txt");
			}

			if (addPostalCodeRuleTemplate == null) {
				addPostalCodeRuleTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-postal-code-rule.txt");
			}

			if (actionTemplate == null) {
				actionTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/action.txt");
			}

			if (addProcessorFactoryTemplate == null) {
				addProcessorFactoryTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-processor-factory.txt");
			}

			if (addFieldToActionTemplate == null) {
				addFieldToActionTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-field-to-action.txt");
			}

			if (addActionToActionsTemplate == null) {
				addActionToActionsTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-action-to-actions.txt");
			}

			if (pageTemplate == null) {
				pageTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/page.txt");
			}

			if (addPageToPagesTemplate == null) {
				addPageToPagesTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-page-to-pages.txt");
			}

			if (objectBindingTemplate == null) {
				objectBindingTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/object-binding.txt");
			}

			if (addFieldToBindingTemplate == null) {
				addFieldToBindingTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-field-to-binding.txt");
			}

			if (addCollectionFieldToBindingTemplate == null) {
				addCollectionFieldToBindingTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-collection-field-to-binding.txt");
			}

			if (addBindingToBindingsTemplate == null) {
				addBindingToBindingsTemplate = resourceReader.readResource("/com/bws/jdistil/builder/generator/template/configuration/add-binding-to-bindings.txt");
			}
		}
