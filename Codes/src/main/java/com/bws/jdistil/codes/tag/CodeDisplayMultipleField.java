...
import com.bws.jdistil.core.tag.data.DisplayMultipleListField;
...
/**
  Component used to display a list of codes for a specified category.
  @author Bryan Snipes
*/
public class CodeDisplayMultipleField extends DisplayMultipleListField {

  /**
   * Serial version UID.
   */
	private static final long serialVersionUID = 2137780574424027768L;
  ...
  */
  ...
  /**
    Creates a new CodeDisplayField object.
  */
  public CodeDisplayMultipleField() {
    super();
  }
    ...
    if (items == null) {
      ...
      if (categoryId != null) {
        ...
        try {
          ...
          logger.logp(Level.SEVERE, getClass().getName(), methodName, "Building Code Display Field", dataSourceException);
