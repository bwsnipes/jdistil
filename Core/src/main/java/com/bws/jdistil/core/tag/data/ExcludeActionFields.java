...
/**
  ...
  @author Bryan Snipes
*/
public class ExcludeActionFields extends ValueComponent {
  ...
  */
  public int doStartTag() throws JspException {
    ...
    if (fields != null) {
        ...
        // Exclude field IDs for non-aliased action
    		excludeActionFields(fields, actionId);
    	}
    	else {
    		...
    		if (attributeValue != null) {
    			...
    			// Only string values can be used to exclude action fields
    			if (attributeValue instanceof String) {
    				
      			// Exclude action field IDs
    				excludeActionFields(fields, (String)attributeValue);
    			}
    		}
    		else {
      		...
      		// Attempt to find actual field IDs in parameter values 
    			...
    			if (parameterValues != null && parameterValues.length > 0) {
        			...
        			// Exclude action field IDs
      				excludeActionFields(fields, parameterValue);
    				}
    			}
    		}
    	}
  ...
  /**
    ...
    @param actionId Action ID.
  */
  private void excludeActionFields(Fields fields, String actionId) {
