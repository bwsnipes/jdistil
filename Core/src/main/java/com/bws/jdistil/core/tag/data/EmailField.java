...
/**
  ...
  @author - Bryan Snipes
*/
public class EmailField extends ValueComponent {

  /**
   * Serial version UID.
   */
	private static final long serialVersionUID = 6302319682663108445L;
  ...
  public int doStartTag() throws JspException {
    ...
    try {
      ...
      if (isHidden || isReadOnly) {
        ...
        setDynamicAttribute(null, "type", "email");
      }
      ...
      // Write email field as HTML email or text field
      ...
      logger.logp(Level.SEVERE, getClass().getName(), methodName, "Building Email Field", uiException);
      ...
      // Post error message
      Logger logger = Logger.getLogger("com.bws.jdistil.core.tag.data");
      logger.logp(Level.SEVERE, getClass().getName(), methodName, "Building Email Field", ioException);
