...
/**
  ...
  @author - Bryan Snipes
*/
public class PhoneNumberRule extends RegularExpressionRule {

	public static final String PHONE_NUMBER_PATTERN = "\\d{3}-\\d{3}-\\d{4}$";
	
	public static final String PHONE_NUMBER_DISPLAY_FORMAT = "###-###-####";
	
  /**
    Creates an PhoneNumberRule object.
  */
  public PhoneNumberRule() {
    super(PHONE_NUMBER_PATTERN, PHONE_NUMBER_DISPLAY_FORMAT);
  }
