...
/**
  Defines all order condition methods. Serves as a tag interface for
  OrderCondition and OrderConditions classes.
  @author - Bryan Snipes
*/
public interface IOrderCondition extends ISqlGenerator {
